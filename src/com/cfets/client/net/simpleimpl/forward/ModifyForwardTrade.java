 ...
 * Time: 下午9:08
 */
public class ModifyForwardTrade {
    private ExecutionReport message;

    public ModifyForwardTrade() {
...
//        message.set(field11071);
        ...
        TrdType field828 = new TrdType("100");
        ...
        PrincipalPaymentRate field10241 = new PrincipalPaymentRate("63453");//即期成本汇率
        LastPx field31 = new LastPx("1.218094");
        message.set(field31);
        message.set(field10241);
        TrdPurpose field10993 = new TrdPurpose(1);//交易目的
...
//        message.set(field11058);
        ...
        DealID field10041 = new DealID("qixin3020");
...
//        NetGrossInd
//        NoUsernames
        LiquidatIndicator field11057 = new LiquidatIndicator("N");//是否允许送后台清算
...
//        NoRelatedReference
        ...
        PartyID field448_1 = new PartyID("1");//本方机构编码
